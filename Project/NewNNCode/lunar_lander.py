...
# Class provided to determine 
# if the legs of the rocket
# contact the ground
...
class LunarLander(gym.Env):
    ...
    def __init__(self):
        ...
        high = np.array([1]*8)  # useful range is -1 .. +1, but spikes can be higher
    ...
    def _reset(self):
        ...
        height[CHUNKS//2-1] = self.helipad_y*2
...
if __name__=="__main__":
    ...
    while iter != 20:
        ...
        while True:
            ...
            #     print("step {} total_reward {:+0.2f}".format(steps, float(total_reward)))
            if done:
                print(["{:+0.2f}".format(x) for x in s])
                print("step {} total_reward {:+0.2f}".format(steps, float(total_reward)))
                break
